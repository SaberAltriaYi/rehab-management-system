...
This product is a derivative work based in part on RuoYi-Vue-Pro（芋道源码）and the Yudao Vue 3 administration frontend.

- RuoYi-Vue-Pro: Copyright (c) 2021 ruoyi-vue-pro
- Yudao Vue 3 administration frontend: Copyright (c) 2021-present Archer
- Upstream source: <https://github.com/YunaiV/ruoyi-vue-pro>
- Upstream frontend source: <https://gitee.com/yudaocode/yudao-ui-admin-vue3>
- Upstream license: MIT License, retained in `LICENSE` and the frontend `LICENSE`

The names “芋道” and “RuoYi-Vue-Pro” are used only to identify the upstream projects. This repository is not an official Yudao project, and no endorsement is implied.
