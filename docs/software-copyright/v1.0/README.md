...
# 运动康复评估与业务管理系统 V1.0 软件著作权材料

本目录是申请材料制作前的可追溯资料包，不包含身份证件、营业执照、签字页、患者数据、密码、密钥或其他个人/基础设施敏感信息。
...
| `10-sensitive-material-review.md` | 数据与敏感信息排查记录 |

制作正式申请材料时，以 `agent/software-copyright-v1` 的最终提交为唯一代码基线，并在导出源程序和说明书后记录提交哈希及文件 SHA-256。
