...
export const StableDiffusionSamplers: ImageModelVO[] = [
  ...
  {
    key: 'K_DPMPP_2M', // gitleaks:allow -- Stable Diffusion 采样器枚举值，不是凭据
    name: 'K_DPMPP_2M'
  },
  {
    key: 'K_DPMPP_2S_ANCESTRAL', // gitleaks:allow -- Stable Diffusion 采样器枚举值，不是凭据
  ...
  {
    key: 'K_DPM_2_ANCESTRAL', // gitleaks:allow -- Stable Diffusion 采样器枚举值，不是凭据
